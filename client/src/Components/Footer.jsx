...
// const Footer = () => {
//   return (
//     <footer className="relative bg-gradient-to-br from-[#050505] via-[#0d0d0d] to-[#161616] text-gray-300 py-10 border-t border-gray-800 mt-10">
//       <motion.div
...
//         >
//           © {new Date().getFullYear()} <span className="text-blue-500 font-semibold">BlogPost</span>. 
//           All rights reserved.
//         </motion.p>

//         {/* Crafted with love line */}
//         <motion.p
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//         <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-64 h-64 bg-blue-500 opacity-10 blur-3xl rounded-full animate-pulse" />
//       </div>
//     </footer>
//   );
// };
