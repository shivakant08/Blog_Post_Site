...
//               <button
//                 type="button"
//                 onClick={()=>window.open("http://localhost:5000/v1/api/google","_self")}
              ...
              {type === "signup" && (
                <>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-400 outline-none text-gray-800 placeholder-gray-500 bg-white/95 mt-3"
                  />
              ...
              {type === "signup" && (
                <div className="relative">
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white/95 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 appearance-none pr-10 mt-2"
                  >
                    <option value="" disabled>Select Role</option>
                    <option value="admin">Admin</option>
                    <option value="user">User</option>
